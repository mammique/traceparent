...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field assigned_scopes on 'Snippet'
        db.create_table(u'tp_metadata_snippet_assigned_scopes', (
        ...
        db.create_unique(u'tp_metadata_snippet_assigned_scopes', ['snippet_id', 'scope_id'])


    def backwards(self, orm):
        # Removing M2M table for field assigned_scopes on 'Snippet'
        db.delete_table('tp_metadata_snippet_assigned_scopes')
