...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field assigned_counters on 'Snippet'
        db.create_table(u'tp_metadata_snippet_assigned_counters', (
        ...
        db.create_unique(u'tp_metadata_snippet_assigned_counters', ['snippet_id', 'counter_id'])


    def backwards(self, orm):
        # Removing M2M table for field assigned_counters on 'Snippet'
        db.delete_table('tp_metadata_snippet_assigned_counters')
    ...
    models = {
        ...
        u'tp_monitor.counter': {
            ...
            'quantities': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'counters'", 'null': 'True', 'to': u"orm['tp_value.Quantity']"}),
