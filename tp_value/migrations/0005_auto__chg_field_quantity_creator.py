...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Quantity.creator'
        db.alter_column(u'tp_value_quantity', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['tp_auth.User']))

    def backwards(self, orm):

        # Changing field 'Quantity.creator'
        db.alter_column(u'tp_value_quantity', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tp_auth.User']))
