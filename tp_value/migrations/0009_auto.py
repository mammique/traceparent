...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Quantity', fields ['uuid']
        db.create_index(u'tp_value_quantity', ['uuid'])

        # Adding index on 'Unit', fields ['uuid']
        db.create_index(u'tp_value_unit', ['uuid'])


    def backwards(self, orm):
        # Removing index on 'Unit', fields ['uuid']
        db.delete_index(u'tp_value_unit', ['uuid'])

        # Removing index on 'Quantity', fields ['uuid']
        db.delete_index(u'tp_value_quantity', ['uuid'])
