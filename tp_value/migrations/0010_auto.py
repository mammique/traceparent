...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Quantity', fields ['datetime']
        db.create_index(u'tp_value_quantity', ['datetime'])

        # Adding index on 'Quantity', fields ['quantity']
        db.create_index(u'tp_value_quantity', ['quantity'])

        # Adding index on 'Unit', fields ['name']
        db.create_index(u'tp_value_unit', ['name'])

        # Adding index on 'Unit', fields ['symbol']
        db.create_index(u'tp_value_unit', ['symbol'])


    def backwards(self, orm):
        # Removing index on 'Unit', fields ['symbol']
        db.delete_index(u'tp_value_unit', ['symbol'])

        # Removing index on 'Unit', fields ['name']
        db.delete_index(u'tp_value_unit', ['name'])

        # Removing index on 'Quantity', fields ['quantity']
        db.delete_index(u'tp_value_quantity', ['quantity'])

        # Removing index on 'Quantity', fields ['datetime']
        db.delete_index(u'tp_value_quantity', ['datetime'])
