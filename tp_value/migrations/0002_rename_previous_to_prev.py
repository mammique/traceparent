...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('tp_value_quantity_previous', 'tp_value_quantity_prev')

    def backwards(self, orm):
        db.rename_table('tp_value_quantity_prev', 'tp_value_quantity_previous')
    ...
    models = {
        ...
        u'tp_value.quantity': {
            ...
            'prev': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'next'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['tp_value.Quantity']"}),
