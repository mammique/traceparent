...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quantity.user_visibility'
        db.add_column(u'tp_value_quantity', 'user_visibility',
                      self.gf('django.db.models.fields.SlugField')(default='public', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quantity.user_visibility'
        db.delete_column(u'tp_value_quantity', 'user_visibility')
