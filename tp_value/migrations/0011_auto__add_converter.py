...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Converter'
        db.create_table(u'tp_value_converter', (
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True, db_index=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='converters_created', to=orm['tp_auth.User'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='converters', to=orm['tp_auth.User'])),
            ('unit_in', self.gf('django.db.models.fields.related.ForeignKey')(related_name='converters_in', to=orm['tp_value.Unit'])),
            ('unit_out', self.gf('django.db.models.fields.related.ForeignKey')(related_name='converters_out', to=orm['tp_value.Unit'])),
            ('type', self.gf('traceparent.fields.SlugBlankToNoneField')(default='operation_simple', max_length=64)),
            ('script', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tp_value', ['Converter'])


    def backwards(self, orm):
        # Deleting model 'Converter'
        db.delete_table(u'tp_value_converter')
