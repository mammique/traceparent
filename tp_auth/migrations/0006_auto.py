...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'User', fields ['uuid']
        db.create_index(u'tp_auth_user', ['uuid'])

        # Adding index on 'User', fields ['name']
        db.create_index(u'tp_auth_user', ['name'])


    def backwards(self, orm):
        # Removing index on 'User', fields ['name']
        db.delete_index(u'tp_auth_user', ['name'])

        # Removing index on 'User', fields ['uuid']
        db.delete_index(u'tp_auth_user', ['uuid'])
