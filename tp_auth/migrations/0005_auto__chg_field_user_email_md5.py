...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.email_md5'
        db.alter_column(u'tp_auth_user', 'email_md5', self.gf('django.db.models.fields.SlugField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'User.email_md5'
        db.alter_column(u'tp_auth_user', 'email_md5', self.gf('django.db.models.fields.SlugField')(default='', max_length=32))
