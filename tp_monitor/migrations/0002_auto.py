...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Counter', fields ['uuid']
        db.create_index(u'tp_monitor_counter', ['uuid'])

        # Adding index on 'ResultSum', fields ['uuid']
        db.create_index(u'tp_monitor_resultsum', ['uuid'])

        # Adding index on 'Mark', fields ['uuid']
        db.create_index(u'tp_monitor_mark', ['uuid'])

        # Adding index on 'Scope', fields ['uuid']
        db.create_index(u'tp_monitor_scope', ['uuid'])


    def backwards(self, orm):
        # Removing index on 'Scope', fields ['uuid']
        db.delete_index(u'tp_monitor_scope', ['uuid'])

        # Removing index on 'Mark', fields ['uuid']
        db.delete_index(u'tp_monitor_mark', ['uuid'])

        # Removing index on 'ResultSum', fields ['uuid']
        db.delete_index(u'tp_monitor_resultsum', ['uuid'])

        # Removing index on 'Counter', fields ['uuid']
        db.delete_index(u'tp_monitor_counter', ['uuid'])
