...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field converters on 'Counter'
        db.create_table(u'tp_monitor_counter_converters', (
        ...
        db.create_unique(u'tp_monitor_counter_converters', ['counter_id', 'converter_id'])


    def backwards(self, orm):
        # Removing M2M table for field converters on 'Counter'
        db.delete_table('tp_monitor_counter_converters')
    ...
    models = {
        ...
        u'tp_value.converter': {
            ...
            'type': ('traceparent.fields.SlugBlankToNoneField', [], {'default': "'operation_basic'", 'max_length': '64'}),
