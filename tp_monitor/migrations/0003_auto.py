...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Counter', fields ['datetime']
        db.create_index(u'tp_monitor_counter', ['datetime'])

        # Adding index on 'Counter', fields ['datetime_start']
        db.create_index(u'tp_monitor_counter', ['datetime_start'])

        # Adding index on 'Counter', fields ['datetime_stop']
        db.create_index(u'tp_monitor_counter', ['datetime_stop'])

        # Adding index on 'Mark', fields ['datetime']
        db.create_index(u'tp_monitor_mark', ['datetime'])

        # Adding index on 'Mark', fields ['quantity']
        db.create_index(u'tp_monitor_mark', ['quantity'])

        # Adding index on 'Scope', fields ['datetime']
        db.create_index(u'tp_monitor_scope', ['datetime'])


    def backwards(self, orm):
        # Removing index on 'Scope', fields ['datetime']
        db.delete_index(u'tp_monitor_scope', ['datetime'])

        # Removing index on 'Mark', fields ['quantity']
        db.delete_index(u'tp_monitor_mark', ['quantity'])

        # Removing index on 'Mark', fields ['datetime']
        db.delete_index(u'tp_monitor_mark', ['datetime'])

        # Removing index on 'Counter', fields ['datetime_stop']
        db.delete_index(u'tp_monitor_counter', ['datetime_stop'])

        # Removing index on 'Counter', fields ['datetime_start']
        db.delete_index(u'tp_monitor_counter', ['datetime_start'])

        # Removing index on 'Counter', fields ['datetime']
        db.delete_index(u'tp_monitor_counter', ['datetime'])
